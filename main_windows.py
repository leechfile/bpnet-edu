...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.exit_btn, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.edu_btn, 2, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.test_nerual.setText(_translate("MainWindow", "实验训练"))
        self.exit_btn.setText(_translate("MainWindow", "退出"))
        self.edu_btn.setText(_translate("MainWindow", "教学演示"))
